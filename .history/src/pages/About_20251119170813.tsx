    ...
    <div className="max-w-5xl mx-auto mt-8 px-4 sm:px-6 lg:px-8 py-10 font-inter">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p className="text-xl text-gray-700 leading-relaxed mb-8">
          The project explores the interactions between hydropower development,
          urban transformation, governance structures, and social equity,
          focusing on how renewable energy initiatives influence power relations
          and socio-environmental dynamics in vulnerable states.
        </p>
